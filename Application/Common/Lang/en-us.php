...
",
    ...
    "虚拟币操作"                                                                                                             => "Coin Deal",
    "开户双重验证功能后，在您每次进行登录操作时，系统都会提示您输入手机应用程序上显示的一次性密码，来确保您的资金安全。您可以依照下面的步骤来设置并启用这一功能。"                                    => "When you have a double verification function, the system will prompt you to enter a one-time password displayed on the phone application program to ensure your capital security. You can set and enable this function in accordance with the following steps.",
    ...
    "转出时间"                                                                                                              => "Out of time",
    "会员之间可以互相转虚拟币，转账即时到账,无法撤销。"                                                                                         => "Members can transfer virtual currency to each other, transfer the money to the account immediately, cannot be rchiaked.",
    "输入对方会员的用户名，一旦输入错误，并且转入后,不可撤销。"                                                                                     => "Enter the user name of the member of the other party, once the error is entered, and after it has been transferred, it cannot be rchiaked.",
    "币种类型"                                                                                                              => "Currency type",
