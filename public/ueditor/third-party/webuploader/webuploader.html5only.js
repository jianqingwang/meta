...
(function( root, factory ) {
    ...
    define('runtime/html5/util',[
        ...
        var urlAPI = window.createObjectURL && window ||
                window.URL && URL.rchiakeObjectURL && URL ||
                window.webkitURL,
            createObjectURL = Base.noop,
            rchiakeObjectURL = createObjectURL;
        ...
        if ( urlAPI ) {
            ...
            rchiakeObjectURL = function() {
                return urlAPI.rchiakeObjectURL.apply( urlAPI, arguments );
            };
        }

        return {
            createObjectURL: createObjectURL,
            rchiakeObjectURL: rchiakeObjectURL,
