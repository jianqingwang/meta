...
<div id="main-content" style="width:100%">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			<span class="h1-title">四方认证</span>
			<div style="float:right;">
				<button style="background: #1BB495;" class="btn btn-success" url="<?php echo U('User/shiming_sifangExcel');?>" target-form="ids" id="submit" type="submit">导出选中</button>
			</div>
		</div>
		<div class="cf">
		...
		<div class="data-table table-striped">
			<form id="form" action="<?php echo U('User/shiming_sifangExcel');?>" method="post" class="form-horizontal">
				<table class="">
					<thead>
					<tr>
					...
					<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><div style="text-align: left;width: 220px;margin:  0 auto;">姓名: <?php echo ($vo["truename"]); ?><br />手机号：<?php echo ($vo["true_mobile"]); ?><br />身份证号：<?php echo ($vo["idcard"]); ?><br />银行卡号：<?php echo ($vo["card"]); ?></div></td>
...
<div style="display:none;">
	...
	<script type="text/javascript" charset="utf-8">
		//导航高亮
		highlight_subnav("<?php echo U('User/index_shiming_sifang');?>");
	</script>