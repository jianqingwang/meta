...
<div id="main-content">
	...
	<div id="main" class="main" style="padding-top:30px;">
			...
			<span class="h1-title">话费充值设置</span>
		</div>
			<div class="tab-wrap">
			<div class="tab-content">
				<form id="form" action="<?php echo U('Chong/index');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
						...
						<div class="form-item cf">
							<table>
								<tr class="controls">
									...
									<td>
										<select name="status" style="display:inline-block;" class="form-control input-10x">
								...
								<tr class="controls" style="border-bottom:#ccc solid 1px;">
									<td class="item-label">任意手机号充值 :</td>
									<td>
										<select name="sta_mobile" style="display:inline-block;" class="form-control input-10x">
											<option value="0" <?php if(($info["sta_mobile"]) == "0"): ?>selected<?php endif; ?>>关闭</option>
											<option value="1" <?php if(($info["sta_mobile"]) == "1"): ?>selected<?php endif; ?>>开启</option>
										</select>
									</td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
									...
									<td><input type="text" class="form-control input-10x" name="money_list" value="<?php echo ($info['money_list']); ?>" /></td>
									<td class="item-note">金额用 | 隔开</td>
								</tr>
								<tr class="controls">
