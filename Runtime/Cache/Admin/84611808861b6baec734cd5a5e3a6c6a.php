...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			<span class="h1-title"><a href="<?php echo U('Index/index_day');?>">每日统计</a></span>
		</div>
			...
			<table class="">
				<thead>
					<tr>
	                    ...
	                    <th width="">充值USDT</th>
	                    <th width="">提取USDT</th>
	                    <th width="">矿机消耗USDT</th>
	                    <th width="">矿机反币chia</th>
	                    <th width="">chia/USDT卖出总量</th>
	                    <th width="">chia/USDT手续费收入总量</th>
					</tr>
				</thead>
				<tbody>
					<tr>
	                    <td class=""><?php echo ($arr['addtime']); ?></td>
	                    <td class=""><?php echo ($arr['reg_sum']); ?></td>
	                    <td class=""><?php echo ($arr['reg_sum_day']); ?></td>
	                    <td width=""><?php echo ($arr['usdt_ljzr']); ?></td>
	                    <td width=""><?php echo ($arr['usdt_ljzc']); ?></td>
	                    <td width=""><?php echo ($arr['usdt_xhao']); ?></td>
	                    <td width=""><?php echo ($arr['uti_add']); ?></td>
	                    <td width=""><?php echo ($arr['num_mc']); ?></td>
	                    <td width=""><?php echo ($arr['num_fee']); ?></td>
	                </tr>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
	                    <td class=""><?php echo ($vo['addtime']); ?></td>
	                    <td class=""><?php echo ($vo['reg_sum']); ?></td>
	                    <td class=""><?php echo ($vo['reg_sum_day']); ?></td>
	                    <td width=""><?php echo ($vo['usdt_ljzr']); ?></td>
	                    <td width=""><?php echo ($vo['usdt_ljzc']); ?></td>
	                    <td width=""><?php echo ($vo['usdt_xhao']); ?></td>
	                    <td width=""><?php echo ($vo['uti_add']); ?></td>
	                    <td width=""><?php echo ($vo['num_mc']); ?></td>
	                    <td width=""><?php echo ($vo['num_fee']); ?></td>
...
<div style="display:none;">
	...
	<script type="text/javascript" charset="utf-8">
		//导航高亮
		highlight_subnav("<?php echo U('Trade/index_tongji');?>");
	</script>