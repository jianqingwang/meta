...
<div id="main-content">
    ...
    <div id="main" class="main">
        <div class="main-title-h"><span class="h1-title">全部明细</span></div>
        <div class="cf">
                ...
                <div class="sleft">
                    <form name="formSearch" id="formSearch" method="get" name="form1" >
                        ...
                        <select style=" width: 160px; float: left; margin-right: 10px;" name="coin" class="form-control">
                            ...
                            <?php if(is_array($coin)): $i = 0; $__LIST__ = $coin;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$coin_arr): $mod = ($i % 2 );++$i;?><option value="<?php echo ($coin_arr['name']); ?>" <?php if(($_GET['coin']) == $coin_arr['name']): ?>selected<?php endif; ?>><?php echo ($coin_arr['js_yw']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                        <select name="protype" style="float: left; margin-right: 10px;width: 160px;" class="form-control">
                        	<option value="">选择类型</option>
                        	<option value="0">官方操作</option>
                        	<option value="6">矿机日收益</option>
                        	<option value="7">领取矿机收益</option>
                        	<option value="11">达人手续费分红</option>
                        	<option value="13">话费充值</option>
                        	<option value="jyzhi">经验值</option>
                        	<option value="ww_td">矿力</option>
                        	<option value="30">开启商家</option>
                        	<option value="31">关闭商家</option>
                        </select>
