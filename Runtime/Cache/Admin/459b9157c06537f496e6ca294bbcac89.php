...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			<span class="h1-title">币种管理 <a class="btn btn-info" href="<?php echo U('Config/coinEdit');?>">新增币种</a></span>
		</div>
		<div class="cf">
			<div class="fl">
			...
			<table class="">
				<thead>
					<tr>
						...
						<th width="25%" class="">中心钱包地址</th>
						<th width="25%" class="">ERC20合约地址</th>
				...
				<tbody>
					<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><?php echo ($vo["js_yw"]); ?></td>
								<td>
									<?php if(($vo["token_type"]) == "1"): ?>ETH (ERC20)
									<?php else: ?>
										<?php if(($vo["type"]) == "qbb"): ?>钱包币<?php endif; ?>
										<?php if(($vo["type"]) == "ptb"): ?>平台币<?php endif; ?>
										<?php if(($vo["type"]) == "api"): ?>币安API<?php endif; ?>
										<?php if(($vo["type"]) == "rgb"): ?>认购币<?php endif; ?>
										<?php if(($vo["type"]) == "rmb"): ?>法定货币<?php endif; endif; ?>
								</td>
								<td>
									<a href="https://cn.etherscan.com/address/<?php echo ($vo["dj_yh"]); ?>" target="_Blank"><?php echo ($vo["dj_yh"]); ?></a>
								</td>
								<td>
									<?php echo ($vo["dj_hydz"]); ?>
								</td>
								...
								<td>
									<?php if(($vo["name"]) != "cny"): ?><a href="<?php echo U('Config/coinEdit?id='.$vo['id']);?>" class="btn btn-primary btn-xs"><img style="width: 22px;margin-bottom: 3px;margin-right: 4px;" title="编辑" src="/Public/Admin/images/c-ic3.png"/></a><?php endif; ?>
								</td>
