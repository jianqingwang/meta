...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			<span class="h1-title">会员等级
				 <a class="btn btn-success " href="<?php echo U('user_add');?>">新 增</a>
			</span>
		</div>
		...
		<form id="form" method="post" class="form-horizontal">
			<table class="">
				...
				<tr>
					...
					<th class="">转出手续费</th>
					<th class="">转出最小数量</th>
					<th class="">话费充值累计次数</th>
					<th class="">话费每月充值次数</th>
					<th class="">话费充值折扣</th>
					<th class="">话费充值手续费</th>
					<th class="">操作</th>
				</tr>
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							<td><img src="/Upload/logo/<?php echo ($vo["img"]); ?>" style="width:30px;" /></td>
							<td><?php echo ($vo["name"]); ?></td>
							<td><?php echo ($vo["zt_ren"]); ?></td>
							<td><?php echo ($vo["empirical_num"]); ?></td>
							<td><?php echo ($vo["trade_cs"]); ?></td>
							<td><?php echo ($vo["trade_num"]); ?></td>
							<td><?php echo ($vo['fee_mc']*100); ?> %</td>
							<td><?php if($vo['fee_zc_type']==1){ echo '单笔固定扣除';}else{ echo '百分比扣除'; } ?></td>
							<td><?php echo ($vo['fee_zc']*1); ?></td>
							<td><?php echo ($vo['zc_min']*1); ?></td>
							<td><?php echo ($vo['chong_num']*1); ?></td>
							<td><?php echo ($vo['chong_num_yue']*1); ?></td>
							<td><?php echo ($vo['chong_zhe']*10); ?> 折</td>
							<td><?php echo ($vo['fee_cz']*100); ?> %</td>
							<td>
								
								<a href="<?php echo U('user_edit?id='.$vo['id']);?>" class="btn btn-primary btn-xs"><img style="width: 22px;margin-bottom: 3px;margin-right: 4px;" title="编辑" src="/Public/Admin/images/c-ic3.png"/> </a>
					...
					<?php else: ?>
					<td colspan="14" class="text-center">Oh! 暂时还没有内容!</td><?php endif; ?>
				</tbody>
			</table>
		</form>
			<div class="page">
...
<div style="display:none;">
	...
	<script type="text/javascript" charset="utf-8">
		//导航高亮
		highlight_subnav("<?php echo U('Trade/trade');?>");
	</script>