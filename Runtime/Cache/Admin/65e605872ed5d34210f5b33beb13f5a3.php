...
<div id="main-content" style="width:100%;">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			...
			<a class="btn btn-success" style="width: 94px;padding-left:9px;font-size: 12px;" href="<?php echo U('User/useradd');?>">
				<img style="width: 16px;margin-bottom: 3px;margin-right: 4px;" src="/Public/Admin/images/resihes.png"/>新增会员
			</a>
			<div style="float:right;">
				<button style="background: #EF5464;" class="ajax-post btn  btn-warning  ajax-post" url="<?php echo U('User/status',array('type'=>'forbid'));?>" target-form="ids">禁止登录</button>
			...
			<div class="search-form fr cf">
				<div class="sleft">
					<form name="formSearch" id="formSearch" method="get" name="form1">
						...
						<select style="width: 150px;float:left;margin-right:10px;  border-radius: 3px;" name="level_user" class="form-control">
							<option value="" >个人等级</option>
							<?php if(is_array($leveluser)): $i = 0; $__LIST__ = $leveluser;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo3): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo3['id']); ?>" <?php if(($_GET['level_user']) == $vo3['id']): ?>selected<?php endif; ?>> <?php echo ($vo3['name']); ?> </option><?php endforeach; endif; else: echo "" ;endif; ?>
						</select>
						<select style="width: 150px;float:left;margin-right:10px;  border-radius: 3px;" name="level_tuandui" class="form-control">
							<option value="" >团队等级</option>
							<?php if(is_array($leveltuandui)): $i = 0; $__LIST__ = $leveltuandui;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo4): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo4['id']); ?>" <?php if(($_GET['level_tuandui']) == $vo4['id']): ?>selected<?php endif; ?>> <?php echo ($vo4['name']); ?> </option><?php endforeach; endif; else: echo "" ;endif; ?>
						</select>
					...
					<tr>
						...
						<th class="" >
							<span style="width:100px;display:inline-block;">
								<span style="display: inline-block;">个人等级</span>
					     	<span style="float:right;">
							<a style="display:block;height: 9px;line-height: 9px;margin-top: 2px;"  href="<?php echo U('User/index?type=level_user&px=asc');?>"><?php if($type=='level_user' && $px=='asc'){ ?> <img title="升序" src="/Public/Admin/menu/shang2.png" alt="" style="width:1rem;"/> <?php }else{ ?> <img title="升序" src="/Public/Admin/menu/shang1.png" alt="" style="width:1rem;"/><?php } ?></a>
							<a  style="display:block;height: 9px;line-height: 9px;" href="<?php echo U('User/index?type=level_user&px=desc');?>"><?php if($type=='level_user' && $px=='desc'){ ?> <img title="降序" src="/Public/Admin/menu/xia2.png" alt="" style="width:1rem;"/> <?php }else{ ?> <img title="降序" src="/Public/Admin/menu/xia1.png" alt="" style="width:1rem;"/><?php } ?></a>
							</span>
							</span>
						</th>
						<th class="" >
							<span style="width:100px;display:inline-block;">
								<span style="display: inline-block;">团队等级</span>
					     	<span style="float:right;">
							<a style="display:block;height: 9px;line-height: 9px;margin-top: 2px;"  href="<?php echo U('User/index?type=level_tuandui&px=asc');?>"><?php if($type=='level_tuandui' && $px=='asc'){ ?> <img title="升序" src="/Public/Admin/menu/shang2.png" alt="" style="width:1rem;"/> <?php }else{ ?> <img title="升序" src="/Public/Admin/menu/shang1.png" alt="" style="width:1rem;"/><?php } ?></a>
							<a  style="display:block;height: 9px;line-height: 9px;" href="<?php echo U('User/index?type=level_tuandui&px=desc');?>"><?php if($type=='level_tuandui' && $px=='desc'){ ?> <img title="降序" src="/Public/Admin/menu/xia2.png" alt="" style="width:1rem;"/> <?php }else{ ?> <img title="降序" src="/Public/Admin/menu/xia1.png" alt="" style="width:1rem;"/><?php } ?></a>
							</span>
							</span>
						</th>
						...
						<th class="" >
							<span style="width:100px;display:inline-block;">
								<span style="display: inline-block;">直推人数</span>
					     	<span style="float:right;">
							<a style="display:block;height: 9px;line-height: 9px;margin-top: 2px;"  href="<?php echo U('User/index?type=r_nums&px=asc');?>"><?php if($type=='r_nums' && $px=='asc'){ ?> <img title="升序" src="/Public/Admin/menu/shang2.png" alt="" style="width:1rem;"/> <?php }else{ ?> <img title="升序" src="/Public/Admin/menu/shang1.png" alt="" style="width:1rem;"/><?php } ?></a>
							<a  style="display:block;height: 9px;line-height: 9px;" href="<?php echo U('User/index?type=r_nums&px=desc');?>"><?php if($type=='r_nums' && $px=='desc'){ ?> <img title="降序" src="/Public/Admin/menu/xia2.png" alt="" style="width:1rem;"/> <?php }else{ ?> <img title="降序" src="/Public/Admin/menu/xia1.png" alt="" style="width:1rem;"/><?php } ?></a>
							</span>
							</span>
						</th>
						<th class="" style="width:124px;">
							<span style="width:100px;display:inline-block;">
							<span style="display: inline-block;">团队人数</span>
							<span style="float:right;">
							<a style="display:block;height: 9px;line-height: 9px;margin-top: 2px;"  href="<?php echo U('User/index?type=xq_nums&px=asc');?>"><?php if($type=='xq_nums' && $px=='asc'){ ?> <img title="升序" src="/Public/Admin/menu/shang2.png" alt="" style="width:1rem;"/> <?php }else{ ?> <img title="升序" src="/Public/Admin/menu/shang1.png" alt="" style="width:1rem;"/><?php } ?></a>
							<a  style="display:block;height: 9px;line-height: 9px;" href="<?php echo U('User/index?type=xq_nums&px=desc');?>"><?php if($type=='xq_nums' && $px=='desc'){ ?> <img title="降序" src="/Public/Admin/menu/xia2.png" alt="" style="width:1rem;"/> <?php }else{ ?> <img title="降序" src="/Public/Admin/menu/xia1.png" alt="" style="width:1rem;"/><?php } ?></a>
								</span>
									</span>
						</th>
						<th class="">有效直推</th>
						...
						<th class="">团队矿力</th>
						<th class="">注册时间</th>
						<th class="" width="200" style="text-align:center;"><span style="width:230px;display: inline-block;">操作管理</span></th>
					</tr>
					</thead>
					<tbody>
					<?php if(!empty($list22)): if(is_array($list22)): $i = 0; $__LIST__ = $list22;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								<td><input class="ids" type="checkbox" name="id[]" value="<?php echo ($vo["id"]); ?>"/></td>
								<td title="登录该用户"><a href="<?php echo U('User/loginadmin?id='.$vo['id'].'&pass='.$vo['password']);?>" target="_blank"><?php echo ($vo["id"]); ?></a></td>
								<td><a href="<?php echo U('User/index?field=zt_mobile&name='.$vo['mobile']);?>"><?php echo ($vo["mobile"]); ?></a></td>
								...
								<td><?php echo ($vo["level_tuandui"]); ?></td>
                              	...
                              	<td><a href="javascript:;" onclick="showid('<?php echo ($vo['id']); ?>');">钱包地址</a></td>
                              	<td><span class="bg-2"><?php echo ($vo["r_nums"]); ?></span></td>
                              	<td><span class="bg-3"><?php echo ($vo["xq_nums"]); ?></span></td>
                              	<td><span class="bg-1"><?php echo ($vo['youxiao']*1); ?></span></td>
                              	<td><span class="bg-1"><?php echo ($vo['jyzhi2']*1); ?></span></td>
								...
								<td>
									<?php if($vo['sta_pipei']==0){ ?>
									<a class="btn btn-success" style="width: 94px;padding-left:9px;font-size: 12px;" onclick="shiming_ok(<?php echo ($vo['id']); ?>)" >
										开启实名不验证匹配信息
									</a>
									<?php }else{ ?>
									<a class="btn btn-success" style="width: 94px;padding-left:9px;font-size: 12px;" onclick="shiming_no(<?php echo ($vo['id']); ?>)" >
										关闭实名不验证匹配信息
									</a>
									<?php } ?>
									...
									<?php if($vo['sta_tibi']==1){ ?>
										<img onclick="tibi_no(<?php echo ($vo['id']); ?>)" style="width: 22px;margin-bottom: 3px;margin-right: 4px;" title="禁止提币" src="/Public/Admin/menu/an1.png"/>
									<?php }else{ ?>
										<img onclick="tibi_start(<?php echo ($vo['id']); ?>)" style="width: 22px;margin-bottom: 3px;margin-right: 4px;" title="开启提币" src="/Public/Admin/menu/an1.png"/>
									<?php } ?>
									<!--<?php if($vo['sta_kjfhong']==1){ ?>
										<img onclick="kjfhong_no(<?php echo ($vo['id']); ?>)" style="width: 22px;margin-bottom: 3px;margin-right: 4px;" title="禁止矿机分红" src="/Public/Admin/menu/an2.png"/>
									<?php }else{ ?>
										<img onclick="kjfhong_start(<?php echo ($vo['id']); ?>)" style="width: 22px;margin-bottom: 3px;margin-right: 4px;" title="开启矿机分红" src="/Public/Admin/menu/an2.png"/>
									<?php } ?>
									<?php if($vo['sta_tuandui']==1){ ?>
										<img onclick="tuandui_no(<?php echo ($vo['id']); ?>)" style="width: 22px;margin-bottom: 3px;margin-right: 4px;" title="禁止团队奖" src="/Public/Admin/menu/an4.png"/>
									<?php }else{ ?>
										<img onclick="tuandui_start(<?php echo ($vo['id']); ?>)" style="width: 22px;margin-bottom: 3px;margin-right: 4px;" title="开启团队奖" src="/Public/Admin/menu/an4.png"/>
									<?php } ?>-->
									<?php if($vo['shop']==1){ ?>
										<img onclick="close_shop(<?php echo ($vo['id']); ?>)" style="width: 22px;margin-bottom: 3px;margin-right: 4px;" title="关闭商家" src="/Public/Admin/images/end.png"/>
									<?php }else{ ?>
										<img onclick="start_shop(<?php echo ($vo['id']); ?>)" style="width: 22px;margin-bottom: 3px;margin-right: 4px;" title="开启商家" src="/Public/Admin/images/start.png"/>
									<?php } ?>
                                  	<a href="<?php echo U('User/loginadmin?id='.$vo['id']);?>" target="_blank" class="btn-xs" >
                                  		<img style="width: 22px;margin-bottom: 3px;margin-right: 4px;" title="登录前台" src="/Public/Admin/images/c-ic4.png"/>
                                  	</a>
                                  	<?php if($vo['denglu_time']>time()){ ?>
    								<button style="border: none;background: none;" title="解冻" class="ajax-post" type="button" onclick="jiedong_10fenzhong(<?php echo ($vo['id']); ?>)">
                                    	解冻
                                    </button>
    								<?php }?>
                                </td>
...
<div class="user_tan"  style="display:none;">
								<div class="user_kuang">
		                          ...
		                          <div class="address_mas">
		                          		<div class="user_kuang_div">UTI地址：<span id="uti"></span> <span class="rec_fu btn btn-info uti2" data-clipboard-text="">复制</span></div>
...
function start_shop(id){
  	layer.open({
      	...
      	yes: function(){
			$.ajax({
				type:'post',
				url:'<?php echo U("User/start_shop");?>',
				data:{'id':id},
				cache:false,
				dataType:'json',
...
function close_shop(id){
  	layer.open({
      	...
      	yes: function(){
			$.ajax({
				type:'post',
				url:'<?php echo U("User/close_shop");?>',
				data:{'id':id},
				cache:false,
				dataType:'json',
				success:function(data){
...
function shiming_ok(id){
  	layer.open({
      	content: '您确认要开启实名不验证匹配信息吗？',
      	btn: ['确认', '取消'],
      	shadeClose: false,
      	yes: function(){
			$.ajax({
				type:'post',
				url:'<?php echo U("User/shiming_ok_mas");?>',
				data:{'id':id},
				cache:false,
				dataType:'json',
				success:function(data){
...
function shiming_no(id){
  	layer.open({
      	content: '您确认要关闭实名不验证匹配信息吗？',
      	btn: ['确认', '取消'],
      	shadeClose: false,
      	yes: function(){
			$.ajax({
				type:'post',
				url:'<?php echo U("User/shiming_no_mas");?>',
				data:{'id':id},
				cache:false,
				dataType:'json',
				success:function(data){
...
function tibi_start(id){
  	layer.open({
      	...
      	yes: function(){
			$.ajax({
				type:'post',
				url:'<?php echo U("User/tibi_start");?>',
				data:{'id':id},
				cache:false,
				dataType:'json',
				success:function(data){
...
function tuandui_start(id){
  	layer.open({
      	...
      	yes: function(){
			$.ajax({
				type:'post',
				url:'<?php echo U("User/tuandui_start");?>',
				data:{'id':id},
				cache:false,
				dataType:'json',
				success:function(data){
...
function tuandui_no(id){
  	layer.open({
      	...
      	yes: function(){
			$.ajax({
				type:'post',
				url:'<?php echo U("User/tuandui_no");?>',
				data:{'id':id},
				cache:false,
				dataType:'json',
				success:function(data){
...
function kjfhong_start(id){
  	layer.open({
      	...
      	yes: function(){
			$.ajax({
				type:'post',
				url:'<?php echo U("User/kjfhong_start");?>',
				data:{'id':id},
				cache:false,
				dataType:'json',
				success:function(data){
...
function kjfhong_no(id){
  	layer.open({
      	...
      	yes: function(){
			$.ajax({
				type:'post',
				url:'<?php echo U("User/kjfhong_no");?>',
				data:{'id':id},
				cache:false,
				dataType:'json',
				success:function(data){
...
function jiedong_10fenzhong(id){
  	layer.open({
      	content: '您确认要解冻吗？',
      	btn: ['确认', '取消'],
      	shadeClose: false,
      	yes: function(){
			$.ajax({
				type:'post',
				url:'<?php echo U("User/jiedong_10fenzhong");?>',
				data:{'id':id},
				cache:false,
				dataType:'json',
				success:function(data){
...
function nu(obj){
    ...
    obj.value = obj.value.replace(/^(\-)*(\d+)\.().*$/,'$1$2.$3'); //只能输入两个小数  几个\d保留几位小数
      
}
function ze(num){
	  	var nu = $(num).val();
		$('.tiaozhuan').attr('href','/Admin/User/index.html?&p='+nu+'.html')
	}
