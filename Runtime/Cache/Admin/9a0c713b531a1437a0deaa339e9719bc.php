...
<div id="main-content">
    ...
    <div id="main" class="main">
        <div class="main-title-h"><span class="h1-title">赠送矿机记录&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <font>实名认证<?php echo ($shiming); ?>人，实名赠送矿机<?php echo ($shiming_kj); ?>台，
        	升级Kol1:<?php echo ($shengji_1); ?>人，赠送矿机<?php echo ($shengji_1_kj); ?>台，
        	升级Kol2:<?php echo ($shengji_2); ?>人，赠送矿机<?php echo ($shengji_2_kj); ?>台，
        	升级Kol3:<?php echo ($shengji_3); ?>人，赠送矿机<?php echo ($shengji_3_kj); ?>台，
        	升级Kol4:<?php echo ($shengji_4); ?>人，赠送矿机<?php echo ($shengji_4_kj); ?>台，
        	升级Kol5:<?php echo ($shengji_5); ?>人，赠送矿机<?php echo ($shengji_5_kj); ?>台</font></span>
        	</div>
        <div class="cf">
            <div class="search-form fr cf">
                <div class="sleft">
                    <form name="formSearch" id="formSearch" method="get" name="form1" >
                        ...
                        <select style=" width: 160px; float: left; margin-right: 10px;" name="kjix" class="form-control">
                            <option value="">全部矿机</option>
                            <?php if(is_array($kji)): $i = 0; $__LIST__ = $kji;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$kjix): $mod = ($i % 2 );++$i;?><option value="<?php echo $kjix['id']; ?>" <?php if(@$_GET['kjix']==$kjix['id']){ echo 'selected'; } ?>><?php echo $kjix['name']; ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                        <select style=" width: 160px; float: left; margin-right: 10px;" name="level_x" class="form-control">
                        	<option value="">全部</option>
                            <option value="shiming" <?php if(($_GET['level_x']) == "shiming"): ?>selected<?php endif; ?>>实名</option>
                            <option value="2" <?php if(($_GET['level_x']) == "2"): ?>selected<?php endif; ?>>Kol1</option>
                            <option value="3" <?php if(($_GET['level_x']) == "3"): ?>selected<?php endif; ?>>Kol2</option>
                            <option value="4" <?php if(($_GET['level_x']) == "4"): ?>selected<?php endif; ?>>Kol3</option>
                            <option value="5" <?php if(($_GET['level_x']) == "5"): ?>selected<?php endif; ?>>Kol4</option>
                            <option value="6" <?php if(($_GET['level_x']) == "6"): ?>selected<?php endif; ?>>Kol5</option>
                        </select>
        ...
        <div class="data-table table-striped">
            <table class="">
                ...
                <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($vo['num_usdt']); ?> <?php echo ($vo['coin']); ?></td>
                            <td><?php echo ($vo['h_num']); ?> 小时</td>
                            <td><?php echo ($vo['h_cbi']); ?> chia</td>
                            <td><?php echo ($vo['num']); ?></td>
                            <td><?php echo ($vo['num_usdt_zong']); ?> <?php echo ($vo['coin']); ?></td>
                            <td><?php echo ($vo['num_uti']); ?> chia</td>
                            <td><?php echo ($vo['num_zx']); ?></td>
                            <td><?php echo ($vo['zszt_kl']*1); ?></td>
                            <td><?php if($vo['status']==2){ echo '释放中'; }else if($vo['status']==1){ echo '已完成';}else{ echo '已完成';} ?></td>
                            <td><?php if($vo['sta_syzx']==1){ echo '运行中'; }else{ echo '暂停中';} ?></td>
                            <td><?php echo (addtime($vo['time_add'])); ?></td>
                            <td><?php echo (addtime($vo['time_dq'])); ?></td>
...
<div style="display:none;">
    ...
    <script type="text/javascript" charset="utf-8">
        //导航高亮
        highlight_subnav("<?php echo U('Finance/record_zs_log');?>");
    </script>