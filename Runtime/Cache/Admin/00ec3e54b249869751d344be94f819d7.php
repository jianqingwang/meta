...
<div id="main-content">
	...
	<div id="main" class="main">
		...
		<div class="cf">
			<div class="fl">
				<button class="btn ajax-post confirm btn-danger " url="<?php echo U('User/walletStatus',array('type'=>'del'));?>" target-form="ids">删 除</button>
			</div>
				...
				<div class="sleft">
					<form name="formSearch" id="formSearch" method="get" name="form1">
						<select style="width: 160px; float: left; margin-right: 10px;" name="coinname" class="form-control">
							...
							>币种</option>
							<?php if(is_array($coin)): $i = 0; $__LIST__ = $coin;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['name']); ?>" <?php if(($vo['name']) == $_GET['coinname']): ?>selected<?php endif; ?> ><?php echo ($vo['title']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
						</select>
						<select style=" width: 160px; float: left; margin-right: 10px;" name="field" class="form-control">
							<option value="userid"<?php if(($_GET['field']) == "userid"): ?>selected<?php endif; ?>>用户ID</option>
							<option value="username"<?php if(($_GET['field']) == "username"): ?>selected<?php endif; ?>>账号</option>
		...
		<div class="data-table table-striped">
			<table class="">
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><a href="<?php echo U('User/walletEdit?id='.$vo['id']);?>" class="btn btn-primary btn-xs"><img style="width: 22px;margin-bottom: 3px;margin-right: 4px;" title="编辑" src="/Public/Admin/images/c-ic3.png"/></a>
							</td>
...
<div style="display:none;">
	...
	<script type="text/javascript" charset="utf-8">
		//导航高亮
		highlight_subnav("<?php echo U('User/wallet');?>");
	</script>