    ...
    <div class="admin-login-background">
        <div class="layui-form login-form">
            <form class="layui-form" >
                ...
                <div class="layui-form-item">
                    <button class="layui-btn layui-btn-fluid" type="button" lay-submit="button" lay-filter="login">登 入</button>
                </div>
            </form>
        </div>
    </div>
...
<script src="/Public/js/jquery.particleground.min.js" charset="utf-8"></script>
<script>
