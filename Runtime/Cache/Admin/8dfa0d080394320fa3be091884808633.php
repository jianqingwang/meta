...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			...
			<span class="h1-title">实名信息</span>
		</div>
		<div class="tab-wrap">
			<div class="tab-content">
				<form id="form" action="<?php echo U('User/edit2');?>" method="post" class="form-horizontal">
					<div id="tab" class="tab-pane in tab">
						<div class="form-item cf">
							<table>
								...
								<tr class="controls">
									<td class="item-label">个人等级 :</td>
									<td>
										<select name="level_user">
											<?php if(is_array($leveluser)): $i = 0; $__LIST__ = $leveluser;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?><option <?php if($data['level_user']==$vo2['id']){ echo 'selected'; } ?> value="<?php echo ($vo2['id']); ?>"><?php echo ($vo2['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
									</td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
									<td class="item-label">个人等级锁定 :</td>
									<td>
										<select name="level_suo">
											<option value="0">更新升降</option>
											<option <?php if($data['level_suo']==1){ echo 'selected'; } ?> value="1">不降级</option>
										</select>
									</td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
									<td class="item-label">个人等级 :</td>
									<td>
										<select name="level_tuandui">
											<?php if(is_array($leveldata)): $i = 0; $__LIST__ = $leveldata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($data['level_tuandui']==$vo['id']){ echo 'selected'; } ?> value="<?php echo ($vo['id']); ?>"><?php echo ($vo['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
									</td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
									...
									<td>
										<input type="text" class="form-control input-10x" name="password" value="">
									</td>
									<td class="item-note">不修改留空</td>
								</tr>
								<tr class="controls">
									<td class="item-label">资产密码 :</td>
									<td>
										<input type="text" class="form-control input-10x" name="paypassword" value="">
									</td>
									<td class="item-note">不修改留空</td>
								</tr>
								<tr class="controls">
