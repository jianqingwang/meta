...
<div class="layuimini-container">
    <div class="layuimini-main">
            ...
            <div style="margin: 10px 10px 10px 10px">
                <form class="layui-form layui-form-pane" action="">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            <label class="layui-form-label">下级</label>
                            <div class="layui-input-inline">
                                <input type="text" name="address_child" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
        ...
        <script type="text/html" id="currentTableBar">
            ...
            <a class="layui-btn layui-btn-warm layui-btn-xs data-count-edit" lay-event="three">关系图</a>
        </script>
...
<script>
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            elem: '#currentTableId',
            url: '/index.php/Admin/Index/getUserList',
            toolbar: '#toolbarDemo',
            ...
            cols: [[
                ...
                {field: 'withdraw', width: 120, title: '已结算'},
                {field: 'no_withdraw', width: 120, title: '未结算'},
                {field: 'withdraw_time', width: 120, title: '申请提现时间'},
        ...
        form.on('submit(data-search-btn)', function (data) {
            ...
            table.reload('currentTableId', {
                ...
                , where: {
                    ...
                    address_child: data.field.address_child
                }
            }, 'data');
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {
            ...
            }else if(obj.event === 'provide'){
                layer.confirm('真的发放么？', function (index) {
                    $.ajax({
                        url:"/index.php/Admin/Index/provide/id/"+data.id,
                        type:"post",
                        dataType:'json',
                        data:data,
                ...
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['100%', '100%'],
                    content: '/index.php/Admin/Index/detail/id/'+data.id,
                });
                $(window).on("resize", function () {
                    layer.full(index);
                });
                ...
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['100%', '100%'],
                    content: '/index.php/Admin/Index/three/id/'+data.id,
                });
                $(window).on("resize", function () {
                    layer.full(index);
                });
