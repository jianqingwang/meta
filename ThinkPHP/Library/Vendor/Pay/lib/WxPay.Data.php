...
class WxPayDownloadBill extends WxPayDataBase
{
	...
	**/
	...
	/**
	* 设置ALL，返回当日所有订单信息，默认值SUCCESS，返回当日成功支付的订单REFUND，返回当日退款订单RchiaKED，已撤销的订单
	* @param string $value
	**/
	...
	/**
	* 获取ALL，返回当日所有订单信息，默认值SUCCESS，返回当日成功支付的订单REFUND，返回当日退款订单RchiaKED，已撤销的订单的值
	* @return 值
	**/
	...
	/**
	* 判断ALL，返回当日所有订单信息，默认值SUCCESS，返回当日成功支付的订单REFUND，返回当日退款订单RchiaKED，已撤销的订单是否存在
	* @return true 或 false
	**/
